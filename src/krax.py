...
filler_1 = Container(m=lambda: fillers_m_1.m, out = plc.FILLER_OPEN_1 ,lock=Lock(key=lambda: not hw.DFILLERS_CLOSED_1), closed=plc.FILLER_CLOSED_1, max_sp = 2000)
dfillers_1 = Dosator(m=lambda: fillers_m_1.m, out = plc.DFILLERS_OPEN_1, closed = plc.DFILLERS_CLOSED_1, 
                     containers=[filler_1], lock = Lock( key = lambda: not hw.FILLER_CLOSED_1 or not hw.FILLER_CLOSED_2 or not hw.MIXER_ISON_1 ) ) 
...
filler_2 = Container(m=lambda: fillers_m_2.m, out = plc.FILLER_OPEN_2, closed = plc.FILLER_CLOSED_2, lock = Lock( key = ~plc.DFILLERS_CLOSED_2) ) 
dfillers_2 = Dosator(m=lambda: fillers_m_2.m, out = plc.DFILLERS_OPEN_2, closed = plc.DFILLERS_CLOSED_2, 
                     containers=[filler_2],lock = Lock( key = lambda: not hw.FILLER_CLOSED_2 or not hw.MIXER_ISON_1) ) 
vibrator_2 = Vibrator( containers=[plc.FILLER_OPEN_2], weight=fillers_m_2, q = plc.VIBRATOR_ON_2 )
...
filler_3 = Container(m=lambda: fillers_m_3.m, out = plc.FILLER_OPEN_3, closed = plc.FILLER_CLOSED_3, lock = Lock( key = ~plc.DFILLERS_CLOSED_3) ) 
...
vibrator_3 = Vibrator( containers=[plc.FILLER_OPEN_3], weight=fillers_m_3, q = plc.VIBRATOR_ON_3 )
...
instances+=[running,factory_1,cement_m_1,silage_1,dcement_1,dc_vibrator_1,water_m_1,water_1,dwater_1, additions_m_1, addition_1,addition_2, dadditions_1, 
            fillers_m_1, filler_1, dfillers_1, vibrator_1,df_vibrator_1,
            fillers_m_2, filler_2, dfillers_2, vibrator_2,df_vibrator_2,
            fillers_m_3, filler_3, dfillers_3, vibrator_3,df_vibrator_3,
...
# ifillers_m_1 = iWEIGHT( speed=100,loading = lambda: hw.FILLER_OPEN_1, unloading = plc.DFILLERS_OPEN_1, q = plc.FILLERS_M_1 )
...
# ifillers_m_2 = iWEIGHT( speed=100,loading = lambda: hw.FILLER_OPEN_2, unloading = plc.DFILLERS_OPEN_2, q = plc.FILLERS_M_2 )
...
# ifillers_m_3 = iWEIGHT( speed=100,loading = lambda: hw.FILLER_OPEN_3, unloading = plc.DFILLERS_OPEN_3, q = plc.FILLERS_M_3 )
...
#               ifillers_m_2,ifiller_3,idfillers_2, ifillers_m_3,idfillers_3]
